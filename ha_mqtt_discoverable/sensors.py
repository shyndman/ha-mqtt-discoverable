...
from .device_class import BinarySensorDeviceClass, ButtonDeviceClass, CoverDeviceClass, NumberDeviceClass, SensorDeviceClass, SwitchDeviceClass
...
class SensorInfo(EntityInfo):
    ...
    together with state_class or unit_of_measurement.
    """
...
class SwitchInfo(EntityInfo):
    ...
    """Optional. What type of device this. It will possibly map to google device
    types."""
